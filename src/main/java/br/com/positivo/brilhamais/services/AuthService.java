...
public class AuthService {
    ...
    public AuthResponse login(AuthRequest request) {
        ...
        authenticationManager.authenticate(
                new UsernamePasswordAuthenticationToken(
                        request.getMatriculaCpf(),
                        request.getSenha()
                )
        );

        var tecnico = repository.findByMatriculaCpf(request.getMatriculaCpf())
                .orElseThrow();
    ...
    public void changePassword(String matriculaCpf, String novaSenha) {
        var tecnico = repository.findByMatriculaCpf(matriculaCpf)
